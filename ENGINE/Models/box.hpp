#ifndef MARCHING_CUBES_BOX_HPP
#define MARCHING_CUBES_BOX_HPP
...
#include "../Graphics/Memory/VertexMemory.h"
...
public:
    void init() {
        ...
        VAO["posVBO"].setAttribPointer<glm::vec3>(1, 3, GL_FLOAT, 1, 0, 1);
        ...
        VAO["sizeVBO"].setAttribPointer<glm::vec3>(2, 3, GL_FLOAT, 1, 0, 1);
        VAO["sizeVBO"].clear();
    ...
    void addInstance(Bounds br, glm::vec3 pos, glm::vec3 size) {
